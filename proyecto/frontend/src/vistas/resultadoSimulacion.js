...
export default function ResultadoSimulacion() {
  ...
  return (
    <div id="resultadoSimulacion" style={{
      ...
      {/* barra de arriba */}
      <header style={{
        backgroundColor: "#1a1f3c", color: "white",
        ...
        <div style={{ fontSize: "25px", fontWeight: "bold" }}>
          <img src={logo} alt="Logo" style={{
            width: "auto", height: "clamp(30px, 5vw, 45px)", maxWidth: "120px",
          }} />
        </div>
        <div style={{
          display: "flex", gap: "clamp(15px, 3vw, 20px)",
          alignItems: "center", flexWrap: "wrap",
        }}>
          <a href="/logout" style={{
            color: "white", textDecoration: "none", fontWeight: "bold",
            fontSize: "clamp(14px, 2vw, 17px)", whiteSpace: "nowrap",
          }}>Cerrar sesión</a>
        </div>
      </header>
